...
<body>
    ...
    <div class="ms-auto text-end">
        ...
        <a class="btn btn-link text-dark px-3 mb-0" href="javascript:;"><i class="fas fa-pencil-alt text-dark me-2"
